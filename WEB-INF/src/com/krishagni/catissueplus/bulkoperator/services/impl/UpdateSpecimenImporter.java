...
import com.krishagni.catissueplus.bulkoperator.events.UpdateSpecimenDto;
...
public class UpdateSpecimenImporter implements ObjectImporter {
	...
	public ObjectImportedEvent importObject(ImportObjectEvent req) {
		if (!(req.getObject() instanceof UpdateSpecimenDto)) {
		...
		SpecimenUpdatedEvent response = specimenService.updateSpecimen(request);
