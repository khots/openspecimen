...
//			System.out.println("--------------- Test Case of ShowHideForms executed successful ------------");
//		}
...
//						List<EntityMap> entityMapList = defaultBizLogic.retrieve(EntityMap.class.getName(), Constants.CONTAINERID,
//								containerId);
...
//											if (condition.getStaticRecordId() == Long.valueOf(Constants.DEFAULT_CONDITION)
//													|| condition.getStaticRecordId() == -1) {
//												count = count + 1;
//											}
//										}
//										if (count == 0) {
...
//				}
//			}
//			System.out.println("--------------- Test Case of ShowHideForms_ALL executed successful ------------");
//		}
//		catch (DynamicExtensionsSystemException e) {
//			e.printStackTrace();
//			fail("Exception occured");
...
//				}
//			}
//			System.out.println("--------------- Test Case of AssociateNoFormsToCP executed successful ------------");
//		}
//		catch (DynamicExtensionsSystemException e) {
//			e.printStackTrace();
//			fail("Exception occured");
